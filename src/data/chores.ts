...
export const CHORE_DEFINITIONS: ChoreDefinition[] = [
  ...
  { id: 'kitchen-table', label: 'Kitchen Table',     room: 'Kitchen',           top: '38%', left: '35%', sceneIndex: 0, messEmoji: '🍽️', cropWidthPct: 2.4 },
  ...
  { id: 'bath2-sink',    label: 'Bathroom 2',        room: 'Bathroom 2',        top: '72%', left: '73.2%', sceneIndex: 3, messEmoji: '🧴', cropWidthPct: 10.2 },
]
